...
public class GraphTest
{
	...
	{
		// I CHANGED TEST CASES TO COMPARE ROAD NAMES AND NOT MEMORY LOCATIONS!!
		assertEquals(new Road(town[2], town[11], 6, "Road_12").roadName, graph.getEdge(town[2], town[11]).roadName);
		assertEquals(new Road(town[3], town[7], 1, "Road_4").roadName, graph.getEdge(town[3], town[7]).roadName);
	}
	...
	{
		// you are comparing objects, so it obviously wont work,
		// the equals method would compare memory location and since your creating a new instance
		// the memomry location would be different
